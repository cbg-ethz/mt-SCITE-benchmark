rule run_scite:
    ...
    shell:"""./../software/SCITE/scite -n {wildcards.num_mutations} -m {wildcards.num_cells} -r 1 -l 1000000 -fd {wildcards.inf_error_rate} -ad 0.001 -max_treelist_size 1  -i {input} -o ../results/inference_output/{wildcards.num_mutations}_{wildcards.concentration}_{wildcards.error_rate}_{wildcards.num_reads}_{wildcards.num_cells}_{wildcards.initial_mutation_freq}/scite_{wildcards.inf_error_rate}_{wildcards.seed}"""

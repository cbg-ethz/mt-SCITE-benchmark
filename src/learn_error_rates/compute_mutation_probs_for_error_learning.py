...
def generate_error_rates(true_error_rate):
    ...
    error_rate_max = true_error_rate * 100
...
def main():
    if len(sys.argv) != 4:
        print("Usage: python compute_mutation_probabilities.py <true_error_rate> <input_dir> <output_dir>")
        sys.exit(1)
    ...
    # Process seeds
    for seed_nr in range(1, 11):  # Adjust range if needed

...
def adapt_data_for_scite_inference(read_counts_file, output_dir):
    ...
    output_file = os.path.join(output_dir, "scite_input.txt")
...
if __name__ == "__main__":
    ...
    adapt_data_for_scite_inference(read_counts_file, output_dir)
